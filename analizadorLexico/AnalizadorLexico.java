...
public class AnalizadorLexico {
    ...
    public Token explorar() throws IOException{
        ...
        case '/':
            if(readch('/')) return Palabra.coment; else return new Token('/');
        }
        ...
        for( ; ; readch()){
            if( preanalisis == '/') continue;
            else if( Character.isLetter(preanalisis)) continue;
            else if( preanalisis == '/') linea = linea + 1;
            else break;
        }
